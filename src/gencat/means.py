...
neighbourhood_meanprices = excel.iloc[18:91, 1:3]

# Prepare the neighbouhood mean prices dataframe
neighbourhood_meanprices = neighbourhood_meanprices.rename(
    columns={
        'Unnamed: 1': 'neighbourhood',
        'Unnamed: 2': 'neighb_meanprice'
    }
)
